...
<html lang="en" ng-app ng-controller="data">
  <head>
    <title>rxc Mining Calculator</title>
    <meta name="description" content="An easy to use utility used to calculate a rxc miner's potential profits in BTC and multiple fiat
                                currencies. The calculator fetches price and rxc network data from the internet
    ...
    <meta name="keywords" content="rxc,Mining,Profitability,Calculator,AngularJS,AJAX,currency,money,profit,finance,cryptocurrency">
